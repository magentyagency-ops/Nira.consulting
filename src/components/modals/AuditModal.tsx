            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
                    ...
                    >
                        ...
                        <div className="hidden md:flex md:w-5/12 bg-white/5 p-8 flex-col justify-between border-r border-white/10 relative overflow-hidden">
                            {/* Glow interne */}
                            <div className="absolute top-0 left-0 w-full h-1/2 bg-nira-blue/20 blur-[60px] rounded-full pointer-events-none" />

                            <div className="relative z-10">
                                <h3 className="text-2xl font-bold text-white mb-2">Passez à l'échelle.</h3>
                                <p className="text-gray-400 text-sm leading-relaxed mb-6">
                                    Décrivez-nous brièvement votre fonctionnement actuel. Notre équipe analysera les process chronophages et vous proposera un plan d'action d'automatisation.
                                </p>
                            </div>
                            ...
                            <div className="relative z-10 mt-auto">
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3">
                                        <div className="w-8 h-8 rounded-full bg-nira-blue/20 flex items-center justify-center text-nira-blue font-bold text-xs">
                                            1
                                        </div>
                                        <span className="text-sm text-gray-300 font-medium">Audit gratuit 30min</span>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-gray-400 font-bold text-xs">
                                            2
                                        </div>
                                        <span className="text-sm text-gray-500">Proposition technique</span>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-gray-400 font-bold text-xs">
                                            3
